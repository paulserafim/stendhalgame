...
public class StartRecordingRandomItemCollectionAction implements ChatAction {
	...
	private static String previousNameQuest = "";
	...
	public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		//Make sure that the previous quest is not assigned again
		while((previousNameQuest.equals(itemname) && (previousQuantity == quantity))){
			itemname = Rand.rand(items.keySet());
			quantity = items.get(itemname);
		}
		
		previousNameQuest = itemname;
